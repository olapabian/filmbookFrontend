...
const Login: React.FC<LoginProps> = () => {
  ...
  return (
    <div className="login">
      {state.showSignUp && (
        <SignUp onClose={toggleSignUp} onRegister={onRegister} />
      )}
      ...
      <div className="login-container">
        <div className="login-header">
          ...
          <h2>
            RecenzujmyRazem - Portal Społecznościowy dla Miłośników Filmów
          </h2>
        </div>
        <div className="login-fields">
          ...
          <button className="btn-create-acc" onClick={toggleSignUp}>
            Zarejestruj się
          </button>
        </div>
      </div>
